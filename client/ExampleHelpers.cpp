...
class ExampleSerializerSettings {
public:
    ...
    static ExampleSerializerSettings *getInstance(){
        if(instance == nullptr){
            instance = new ExampleSerializerSettings();
        }
        return instance;
    }

private:
    explicit ExampleSerializerSettings(){
        instance = this;
        customDateTimeFormat.isStringSet = false;
        customDateTimeFormat.isEnumSet = false;
    }
    static ExampleSerializerSettings *instance;
    CustomDateTimeFormat customDateTimeFormat;
};

ExampleSerializerSettings * ExampleSerializerSettings::instance = nullptr;
...
bool setDateTimeFormat(const QString &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        ExampleSerializerSettings::setDateTimeFormatString(dateTimeFormat);
    }
    return success;
}
...
bool setDateTimeFormat(const Qt::DateFormat &dateTimeFormat){
    ...
    if (dt.isValid()) {
        success = true;
        ExampleSerializerSettings::setDateTimeFormatEnum(dateTimeFormat);
    }
    return success;
}
...
QString toStringValue(const QDateTime &value) {
    if (ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return value.toString(ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
    }

    if (ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return value.toString(ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
    }
...
QString toStringValue(const ExampleObject &value) {
    return value.asJson();
}

QString toStringValue(const ExampleEnum &value) {
    return value.asJson();
}

QString toStringValue(const ExampleHttpFileElement &value) {
    return value.asJson();
}
...
QJsonValue toJsonValue(const QDateTime &value) {
    if (ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
        return QJsonValue(value.toString(ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString));
    }

    if (ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
        return QJsonValue(value.toString(ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum));
    }
...
QJsonValue toJsonValue(const ExampleObject &value) {
    return value.asJsonObject();
}

QJsonValue toJsonValue(const ExampleEnum &value) {
    return value.asJsonValue();
}

QJsonValue toJsonValue(const ExampleHttpFileElement &value) {
    return value.asJsonValue();
}
...
bool fromStringValue(const QString &inStr, QDateTime &value) {
    if (inStr.isEmpty()) {
       ...
       QDateTime dateTime;
        if (ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            dateTime = QDateTime::fromString(inStr, ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            dateTime = QDateTime::fromString(inStr, ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromStringValue(const QString &inStr, ExampleObject &value)
{
    QJsonParseError err;
...
bool fromStringValue(const QString &inStr, ExampleEnum &value) {
    value.fromJson(inStr);
    return true;
}

bool fromStringValue(const QString &inStr, ExampleHttpFileElement &value) {
...
bool fromJsonValue(QDateTime &value, const QJsonValue &jval) {
    ...
    if (!jval.isUndefined() && !jval.isNull() && jval.isString()) {
        if (ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().isStringSet) {
            value = QDateTime::fromString(jval.toString(), ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().formatString);
        } else if (ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().isEnumSet) {
            value = QDateTime::fromString(jval.toString(), ExampleSerializerSettings::getInstance()->getCustomDateTimeFormat().formatEnum);
        } else {
...
bool fromJsonValue(ExampleObject &value, const QJsonValue &jval) {
    bool ok = true;
    if (jval.isObject()) {
...
bool fromJsonValue(ExampleEnum &value, const QJsonValue &jval) {
    value.fromJsonValue(jval);
    return true;
}

bool fromJsonValue(ExampleHttpFileElement &value, const QJsonValue &jval) {
