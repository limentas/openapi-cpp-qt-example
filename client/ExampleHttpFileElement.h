...
#ifndef Example_HTTP_FILE_ELEMENT_H
#define Example_HTTP_FILE_ELEMENT_H
...
Q_DECLARE_METATYPE(oapi_example::ExampleHttpFileElement)

#endif // Example_HTTP_FILE_ELEMENT_H
